...
| 역할 | 이름  | 담당                                                                                                                       |
|------|-----|--------------------------------------------------------------------------------------------------------------------------|
| Backend | 안재호 | 백엔드 팀장, AWS 인프라 구축 및 배포, GEMINI 챗봇, 프론트엔드 연동 설정, 회원 관리, 이메일 인증, 알림 시스템                                                   |
| Backend | 김도윤 | 가계부, 일일챌린지, 월간챌린지                                                                                                        |
| Backend | 김찬우 | 공공데이터 포털 API 연동, 축제 및 도서관 데이터 수집, KAKAO API 연동, BATCH 및 SCHEDULER 처리, 메인페이지 및 네이버 OCR 연동, 갓플 검색 기능, 북마크 추가/삭제, OCR 기능 구현 |
| Backend | 손창민 | 커뮤니티, 커뮤니티 챌린지, 관리자, GCP 기반 Mock 서버 배포                                                                                   |
| Frontend | 이지윤 | PO, 기획 및 디자인, 퍼블리싱,가계부 페이지 담당                                                                                            |
| Frontend | 이현우 | 프론트엔드 팀장, 기획 및 디자인, 퍼블리싱, 로그인/회원가입, 메인 담당                                                                                |
| Frontend | 정지유 | 기획 및 디자인, 퍼블리싱, 유저페이지 담당, 404 페이지                                                                                        |
| Frontend | 조정우 | 기획 및 디자인, 퍼블리싱, 커뮤니티 페이지 담당                                                                                              |
| Frontend | 최연서 | 기획 및 디자인, 퍼블리싱, 갓플 페이지 담당, 관리자 페이지 담당                                                                                    |
